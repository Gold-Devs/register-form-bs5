<?php
// Building A PHP MySQLi Forum Tutorial Series
...
session_start();
// Start your sessions to allow your page to interact with session variables
...
if ($_SESSION['uid']) {
	if (isset($_POST['reply_submit'])) {
		...
		$res4 = mysqli_query($sql4) or die(mysqli_error());
		...
		foreach ($userids as $key) {
			...
			// Execute the SELECT query
			$res5 = mysqli_query($sql5) or die(mysqli_error());
